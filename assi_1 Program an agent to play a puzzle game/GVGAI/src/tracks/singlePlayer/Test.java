...
import tracks.singlePlayer.agent11849058.Agent;
...
public class Test {
    ...
    public static void main(String[] args) {
		...
		//11849058Guangnian_DONG's controller
		String Controller11849058 = "tracks.singlePlayer.agent11849058.Agent";
...
//		int M = 10;
//		for(int i=0; i<M; i++){
//			game = games[gameIdx][1];
//			gameName = games[gameIdx][0];
//			level1 = game.replace(gameName, gameName + "_lvl" + levelIdx);
//			ArcadeMachine.runGames(game, new String[]{level1}, M, Controller11849058, null);
//		}
